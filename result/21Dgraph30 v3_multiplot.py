...
matfiles = glob.glob(os.path.join(mat_dir, "*.mat"))

print("Found MAT files:", len(matfiles))

for filepath in sorted(matfiles):

    matfile = os.path.splitext(os.path.basename(filepath))[0]
    ...
    try:
        ...
        print("Date decode error:", matfile, e)
        continue
